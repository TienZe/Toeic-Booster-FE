...
const CreatePart6: React.FC<CrPartProps> = ({ onUpdate }) => {
  const [group, setGroup] = useState<number>(
    TOEIC_PARTS.Part6.startGroupQuestionIndex,
  ...
  return (
    <>
      ...
      >
        {part6Group.map((_, internalGroupIndex) => {
          const actualGroupIndex =
            internalGroupIndex + TOEIC_PARTS.Part6.startGroupQuestionIndex;

          const startQuestionNumber =
            TOEIC_PARTS.Part6.start +
            internalGroupIndex * TOEIC_PARTS.Part6.questionPerGroup;
          const endQuestionNumber =
            startQuestionNumber + TOEIC_PARTS.Part6.questionPerGroup - 1;
...
const Part6Form: React.FC<Part1FormProps> = ({ groupIndex, onClose }) => {
          ...
          return (
            <Box key={questionIndex} mb={1}>
              <Stack direction="row" spacing={0.5} sx={{ my: 1 }}>
                ...
                >
                  {TOEIC_PARTS.Part6.start +
                    (groupIndex - TOEIC_PARTS.Part6.startGroupQuestionIndex) *
                      TOEIC_PARTS.Part6.questionPerGroup +
                    questionIndex}
                </Box>
                <TextField
                  label="Question"
